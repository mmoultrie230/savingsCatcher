                ...
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">	
                      ...
                      <li class="nav-item cta"><a href="/" class="nav-link icon d-flex align-items-center"><i class="ion-ios-cloud-download mr-2"></i> Home</a></li>
                    </ul>
                  </div>
                  </div>
              </nav>
                    ...
                    <table>
                            <thead>
                                <tr class="table100-head">
                                    ...
                                    <th class="column1">Total Savings</th>
                                </tr>
                            </thead>
                            <tbody>
